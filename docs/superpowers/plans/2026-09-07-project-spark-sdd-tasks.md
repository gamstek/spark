...
**Files:** 新建 `apps/api/Dockerfile`、`nginx/Dockerfile`、`nginx/nginx.conf`、`nginx/proxy_params`、`compose.production.yaml`、`.github/workflows/ci.yml`、`docs/project-spark-deployment.md`、`docs/project-spark-acceptance.md`、`tests/e2e/deployment.spec.ts`；更新 README 和 .env.example。
