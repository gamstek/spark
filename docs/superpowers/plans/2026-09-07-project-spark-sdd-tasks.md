...
**Files:** 新建 `deploy/nginx.conf`、`deploy/Dockerfile.api`、`deploy/Dockerfile.web`、`deploy/compose.production.yaml`、`.github/workflows/ci.yml`、`docs/project-spark-deployment.md`、`docs/project-spark-acceptance.md`、`tests/e2e/deployment.spec.ts`；更新 README 和 .env.example。
